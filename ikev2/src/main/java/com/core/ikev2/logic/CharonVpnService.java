...
import com.core.ikev2.data.VpnType.VpnTypeFeature;
import com.core.ikev2.logic.VpnStateService.ErrorState;
import com.core.ikev2.logic.VpnStateService.State;
import com.core.ikev2.logic.imc.ImcState;
import com.core.ikev2.logic.imc.RemediationInstruction;
import com.core.ikev2.utils.Constants;
import com.core.ikev2.utils.IPRange;
...
public class CharonVpnService extends VpnService implements Runnable, VpnStateService.VpnStateListener
{
	...
	public static final String DISCONNECT_ACTION = "com.core.ikev2.CharonVpnService.DISCONNECT";
//	private static final String NOTIFICATION_CHANNEL = "com.core.ikev2.CharonVpnService.VPN_STATE_NOTIFICATION";
	public static final String CLOSE_BLOCKING_ACTION = "com.core.ikev2.CharonVpnService.CLOSE_BLOCKING";
...
//	private Handler mHandler;
	...
	public int onStartCommand(Intent intent, int flags, int startId)
	{
		...
		if (intent != null)
		{
			...
			//关闭阻塞，释放线程
			if (CLOSE_BLOCKING_ACTION.equals(intent.getAction())) {
				mNextProfile = null;
			...
			else if (!DISCONNECT_ACTION.equals(intent.getAction()))
			{
				...
				if (bundle != null)
				{
					profile = mDataSource.getVpnProfile(bundle.getLong(VpnProfileDataSource.KEY_ID, -1L));
					if (profile != null)
					{
...
//		mHandler = new Handler();
		...
		mDataSource = VpnProfileDataSource.getInstance();
...
//						addNotification();
	 ...
	 */
	private void stopCurrentConnection(boolean stateUpdate)
	{
		synchronized (this)
		{
			...
			{
				if (stateUpdate) setState(State.DISCONNECTING);

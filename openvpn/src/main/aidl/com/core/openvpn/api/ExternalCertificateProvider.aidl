...
interface ExternalCertificateProvider {
     ...
     *
     * EXTRA_ALIAS = "com.core.openvpn.api.KEY_ALIAS"
     * EXTRA_DESCRIPTION = "com.core.openvpn.api.KEY_DESCRIPTION"
     *
     ...
     * <p><ul>
       * <li>int key "com.core.openvpn.api.RSA_PADDING_TYPE", may be set as:
       * <p><ul>

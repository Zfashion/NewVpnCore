...
import com.core.openvpn.api.ExternalCertificateProvider;
...
public class ExtAuthHelper {
    ...
    public static final String ACTION_CERT_CONFIGURATION = "com.core.openvpn.api.ExternalCertificateConfiguration";
    public static final String ACTION_CERT_PROVIDER = "com.core.openvpn.api.ExternalCertificateProvider";

    public static final String EXTRA_ALIAS = "com.core.openvpn.api.KEY_ALIAS";
    public static final String EXTRA_DESCRIPTION = "com.core.openvpn.api.KEY_DESCRIPTION";

...
import com.core.openvpn.api.ExternalAppDatabase;
...
import static com.core.openvpn.core.ConnectionStatus.LEVEL_WAITING_FOR_USER_INPUT;
...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    public static final String START_SERVICE = "com.core.openvpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "com.core.openvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "com.core.openvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "com.core.openvpn.DISCONNECT_VPN";
    public static final String NOTIFICATION_CHANNEL_BG_ID = "openvpn_bg";
    public static final String NOTIFICATION_CHANNEL_NEWSTATUS_ID = "openvpn_newstat";
    public static final String NOTIFICATION_CHANNEL_USERREQ_ID = "openvpn_userreq";

    public static final String NOTIFICATION_CHANNEL_NAME = "openvpn_channel_name";

    public static final String VPNSERVICE_TUN = "vpnservice-tun";
    public final static String ORBOT_PACKAGE_NAME = "org.torproject.android";
    public static final String EXTRA_CHALLENGE_TXT = "com.core.openvpn.core.CR_TEXT_CHALLENGE";
    public static final String EXTRA_CHALLENGE_OPENURL = "com.core.openvpn.core.OPENURL_CHALLENGE";
    private static final String PAUSE_VPN = "com.core.openvpn.PAUSE_VPN";
    private static final String RESUME_VPN = "com.core.openvpn.RESUME_VPN";
...
//            addVpnActionsToNotification(nbuilder);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationChannel notificationChannel = new NotificationChannel(channel, NOTIFICATION_CHANNEL_NAME, NotificationManager.IMPORTANCE_HIGH);
   ...
   /* @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    ...
    PendingIntent getGraphPendingIntent() {
        ...
        return UniteVpnManager.INSTANCE.getNotifyHelper().getVpnPendingIntent(this);
    }
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: com.core.openvpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
...
//        guiHandler = new Handler(getMainLooper());
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("com.core.openvpn.core.OpenVPNThreadv3");
...
*//*
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("com.core.openvpn.VPN_STATUS");

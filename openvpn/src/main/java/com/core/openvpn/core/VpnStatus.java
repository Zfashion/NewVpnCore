...
public class VpnStatus {
    ...
    public static ConnectionStatus getVpnState(){
        return mLastLevel;
    }
...
*/
    ...
    // keytool -printcert -jarfile com.module.openvpn_85.apk
    ...
    public interface StateListener {
        void updateState(String state, String logmessage, int localizedResId, ConnectionStatus level,@Nullable Intent Intent);
